...
return array(
	'master' => array(
		array('script', Proxima::media('js/admin/pages/pages.js'), 'body', 12),
	),
	'edit' => array(
		array('style', Proxima::media('js/admin/libs/tinymce/jscripts/tiny_mce/themes/advanced/skins/cirkuit/ui.css'), 'head', 13),
		array('script', Proxima::media('js/admin/libs/tinymce/jscripts/tiny_mce/jquery.tinymce.js'), 'body', 14),
