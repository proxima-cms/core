			...
			<fieldset>
				...
				<div class="field">
					<?php if ($page_published === TRUE){?>
						<p>
							<?php echo HTML::image(Proxima::media('img/admin/tick-circle-frame.png'), array('style' => 'float:left;margin-right:4px;')); ?>
							This page is published!
						</p>
					<?php } else {?>
						<p>
							<?php echo HTML::image(Proxima::media('img/admin/exclamation-red-frame.png'), array('style' => 'float:left;margin-right:4px;')); ?>
