<div class="action-bar clear">
	<a href="<?php echo URL::site(Route::get('admin')->uri(array('controller' => 'users', 'action' => 'delete', 'id' => $user->id)); ?>" id="delete-user" class="button ui-button default helper-right">
