...
<div class="clear">
	...
	<?php $header_link = URL::site(Route::get('admin/popup-assets')->uri().'?filter='.$filter.'&direction='.$reverse_direction.'&page='.$pagination->current_page); ?>
		...
		<table>
			...
			<tbody>
				...
				<tr>
					...
					<td>
						<a
							href="<?php echo URL::site(Route::get('admin/popup-assets')->uri().'?filter=type-'.$asset->mimetype->type.'&direction='.$direction.'&page='.$pagination->current_page)?>"
